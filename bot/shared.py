...
SHELBY_TASKS_FILE = Path.home() / "shelby" / "data" / "tasks.json"
SHELBY_PROFILE_FILE = Path.home() / "shelby" / "data" / "user_profile.json"
SHELBY_CONVERSATION_FILE = Path.home() / "shelby" / "data" / "conversation_history.json"
...
SHELBY_ROOT_DIR = Path.home() / "shelby"
